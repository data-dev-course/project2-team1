...
function ProtectAnimalList() {
	...
	return (
		<div
			className="protect-animal-list-wrap vertical align-start"
			style={{ width: "100%", maxWidth: "1240px", padding: "20px" }}
		>
			<div
				className="highlight-title"
				style={{ transform: "translateY(0)", padding: "0 20px" }}
			>
				유기동물 공고 목록
			</div>
			<div
				className="number-highlight-line"
				style={{ margin: "20px 0" }}
			></div>

			<div className="protect-animal-list">
				<div
					className="horizontal align-start"
					style={{ width: "100%" }}
				>
					<button
						className="type-select-button"
						onClick={() => setKindType("개")}
						style={{
							backgroundColor:
								kindType === "개" ? "#FF5F15" : "#4E4E4E",
						}}
					>
						개
					</button>
					<button
						className="type-select-button"
						onClick={() => setKindType("고양이")}
						style={{
							backgroundColor:
								kindType === "고양이" ? "#FF5F15" : "#4E4E4E",
						}}
					>
						고양이
					</button>
			...
			<div
				className="horizontal align-center justify-center-wrap"
				style={{ width: "100%", margin: "0 0 60px 0" }}
			>
				{page === 0 ? null : (
					<button
						className="page-button type-select-button"
						onClick={() => {
							setPage(0);
						}}
					>
