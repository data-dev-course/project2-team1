...
function Overview(params) {
    ...
    return(
        <div className="overview vertical" style={{marginTop: "20vh", padding:"20px"}}>
            ...
            <p>각 시도군구의 총 유기건수에 대해 보호 종료 후 상태에 따른 유기건수 비율을 볼 수 있습니다.<br/> 제주특별자치도의 유기건수가 아주 많고 그 중 높은 비율로 안락사가 진행되었음을 보여주고 있습니다.<br/>범례의 항목을 선택해 원하는 항목만 데이터를 볼 수 있습니다.</p>
            ...
            <p>2021년 가구 소득 기준 상위 10개 지역과 하위 10개 지역을 각 지역의 유기건수와 함께 보여주는 차트입니다. <br/> 성남시를 제외한 다른 소득 상위 지역들은 모두 유기 건수가 하위지역에 비해 낮음을 알 수 있습니다.<br/>범례의 항목을 선택해 원하는 항목의 데이터를 볼 수 있습니다.</p>
            <BarChartIncome/>
            <div style={{height:'6rem', width:"50%"}}></div>
            <div className="section-title"> 나이별 유기건수 </div>
            <p>유기건수를 나이별로 분류해 보여주고 있습니다. 태어난지 1살 전후로 가장 많이 유기되고 있음을 알 수 있습니다. <br/> 0살은 태어난 지 60일 미만된 동물들을 의미합니다. <br/> 나이가 많은 동물의 유기건수에 대해 보호소에서 상태변경이나 등록을 진행하지 않았을 수 있는 점 참고 바랍니다.<br/>범례의 항목을 선택해 원하는 항목의 데이터를 볼 수 있습니다.</p>
            <PieChartAge/>
            <div style={{height:'6rem', width:"50%"}}></div>
            <div className="section-title"> 축종별 품종 비율 </div>
            <p>반려동물 인식칩을 통해 등록된 동물과 유기된 동물의 품종을 보여주고 있습니다. 등록 동물 축종의 한계로, 개와 고양이에 대해서 나타냈습니다. <br/> 개의 등록건수가 고양이에 비해 압도적으로 많아, 등록동물 차트에서 고양이의 점유 부분이 선으로 나타납니다.<br/> 비슷하게 등록되고 유기되는 경향이 있지만, 예시로 진도견과 리브라도 리트리버의 경우 많이 유기되지만, 상대적으로 등록건수가 많지 않습니다.</p>
            <TreeMapKind/>
            <div style={{height:'6rem', width:"50%"}}></div>
        </div>
    );
